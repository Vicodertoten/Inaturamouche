...
- Metrics: `METRICS_STORE_FILE`, `METRICS_RETENTION_HOURS`, `METRICS_DASHBOARD_TOKEN`, `METRICS_DASHBOARD_REQUIRE_TOKEN`
- Dashboard: `BALANCE_DASHBOARD_TOKEN`, `BALANCE_DASHBOARD_REQUIRE_TOKEN`
- Beta thresholds: `BETA_REQUIRE_72H`, `BETA_API_ERROR_RATE_MAX`, `BETA_CRASH_FREE_MIN`, `BETA_ACTIVATION_MIN`, etc.
