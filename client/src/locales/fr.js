const fr = {
  ...
  summary: {
    ...
    lose_title: 'Dommage !',
    explanation_title: 'Repère IA',
    explanation_sources: 'Sources utilisées',
    explanation_detail_title: 'Analyse de cette photo',
    explanation_detail_button: 'Analyser cette photo',
    explanation_detail_loading: 'Analyse photo en cours…',
    brief_key_difference_title: 'Ce qui distingue',
    brief_why_tempting_title: 'Pourquoi la confusion',
    brief_next_look_for_title: 'À regarder',
    photo_analysis_summary_title: "Ce que l'on voit ici",
    photo_analysis_clues_title: 'Repères visibles',
    photo_analysis_mislead_title: 'Ce qui a pu tromper',
    photo_analysis_next_check_title: 'Le détail à vérifier',
    photo_analysis_caution_title: 'Lecture prudente',
    sources_toggle_show: 'Voir les sources',
    sources_toggle_hide: 'Masquer les sources',
    sources_empty: 'Aucune source détaillée disponible pour ce conseil.',
    source_kind_description: 'Description',
    source_kind_image: 'Photo',
    source_kind_taxonomy: 'Taxonomie',
    source_kind_synonymy: 'Synonymie',
    source_kind_distribution: 'Répartition',
    confidence_grounded: 'Sources reliées',
    confidence_model_guided: 'Sources cohérentes',
    confidence_limited: 'Sources limitées',
    confidence_fallback: 'Conseil générique',
    photo_confidence_grounded: 'Analyse photo fiable',
    photo_confidence_limited: 'Analyse photo prudente',
    photo_confidence_unavailable: 'Analyse photo indisponible',
    sources_image_count: '{count} photo du round',
    sources_descriptive_count: '{count} source(s) descriptive(s)',
    sources_taxonomic_count: '{count} source(s) taxonomique(s)',
    sources_other_count: '{count} autre(s) source(s)',
    ...
    pedagogy: {
      visual_clue_title: 'Indice visuel clé',
      taxonomic_rule_title: 'Règle taxonomique',
      counter_example_title: 'Contre-exemple',
      confusion_reason_title: 'Pourquoi la confusion',
    },
    explanation_feedback_label: "Cette explication t'a aidé ?",
    explanation_feedback_yes: 'Utile',
    explanation_feedback_no: 'Pas utile',
  },
  species: {
    tabs: {
  ...
  share: {
    share_result: 'Partager mon récap',
    copy_text: 'Copier',
    copied: 'Résultat copié !',
    sharing: 'Préparation du récap…',
    copy_fail: 'Impossible de copier – copie le texte manuellement.',
    opened_recap: 'Récap ouvert dans un nouvel onglet.',
    headline: 'Je viens de finir une partie sur iNaturaQuizz',
    daily_headline: 'J\'ai terminé le défi du jour sur iNaturaQuizz',
    summary_with_pack: 'J\'ai reconnu {score} espèces sur {total} dans « {pack} » sur iNaturaQuizz.',
    summary_without_pack: 'J\'ai reconnu {score} espèces sur {total} sur iNaturaQuizz.',
    invite: 'Regarde mon récap et essaie toi aussi :',
    card_cta: 'Voir le récap et jouer',
    share_text_copied: 'Texte de partage copié.',
    recap_link_copied: 'Lien du récap copié.',
    challenge_opened: 'Défi ouvert dans un nouvel onglet.',
    sheet_eyebrow: 'Récap partageable',
    sheet_title: 'Partager mon récap',
    preview_label: 'espèces reconnues',
    highlight_label: 'Espèce marquante :',
    highlight_label_card: 'Espèce marquante',
    option_share_now: 'Partager maintenant',
    option_share_now_hint: 'Partager ou copier un message prêt à envoyer.',
    option_copy_message: 'Copier le message de partage',
    option_copy_message_hint: 'Copier un texte prêt pour WhatsApp, email ou réseaux sociaux.',
    option_copy_link: 'Copier le lien du récap',
    option_copy_link_hint: 'Pratique pour WhatsApp, email ou réseaux sociaux.',
    option_view_recap: 'Voir le récap',
    option_view_recap_hint: 'Ouvrir la page publique telle qu\'elle sera partagée.',
    option_create_challenge: 'Créer un défi à partir de cette partie',
    option_create_challenge_hint: 'Copier un lien pour inviter quelqu\'un à faire mieux.',
  ...
  about: {
    ...
    what_is_quality: 'Chaque quiz utilise des observations "Research Grade" issues d\'iNaturalist — un contenu naturaliste réel, structuré par l\'identification communautaire.',
    ...
    why_privacy_text: 'Pas de tracking tiers, progression stockée localement, et métriques produit first-party pseudonymes pendant la bêta',
    ...
    how_inat_step4: 'Une fois "Research Grade" = consensus communautaire suffisant selon les critères iNaturalist',
    how_inat_step5: 'iNaturaQuizz l\'utilise pour les quizzes',
    why_research_grade: 'Pourquoi "Research Grade"?',
    research_grade_text: 'iNaturalist applique des critères de qualité stricts. En pratique, le statut "Research Grade" repose surtout sur des observations vérifiables et un accord suffisant de la communauté sur l\'identification.',
    research_grade_result: 'Résultat:',
    research_grade_result_text: 'iNaturaQuizz s\'appuie sur des observations réelles et un cadre de qualité communautaire utile pour l\'apprentissage.',
  ...
  results_share: {
    ...
    kicker: 'Récap partagé',
    hero_title: '{name} a reconnu {correct} espèces sur {total}',
    hero_text: 'Cette partie montre ce qu\'on peut apprendre à reconnaître à partir d\'observations réelles.',
    hero_text_pack: 'Dans le pack « {pack} », cette partie montre ce qu\'on peut apprendre à reconnaître à partir d\'observations réelles.',
    correct: 'Espèces reconnues',
    accuracy: 'Précision',
    highlights: 'Espèces mises en avant',
    species_title: 'Espèces marquantes',
    species_intro: 'Quelques espèces vues pendant cette partie, pour donner envie de rejouer ou de faire mieux.',
    species_correct: 'Reconnue',
    species_wrong: 'À revoir',
    show_more_species: 'Voir les {count} autres espèces',
    cta_title: 'À toi d’essayer',
    cta_text: 'Joue un pack, découvre des espèces réelles et compare ton propre récap en fin de partie.',
    primary_cta: 'Essayer iNaturaQuizz',
    secondary_cta: 'Faire mieux sur ce pack',
    share_button: 'Partager mes résultats',
    copied: 'Lien copié dans le presse-papiers !',
    copy_failed: 'Échec de la copie',
    play_cta: 'Essayer iNaturaQuizz',
