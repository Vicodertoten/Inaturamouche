const en = {
  ...
  tutorial: {
    step1_title: 'Welcome to Inaturamouche!',
    step1_content: 'The goal is to identify species of animals, plants, and fungi to collect them. The more you identify correctly, the bigger your collection grows!',
    step2_title: 'Lives and streak system',
    step2_content: 'Keep your streak alive! Each correct answer increases your counter. Shields 🛡️ protect you from mistakes and preserve your streak.',
    step3_title: 'Game modes',
    step3_content: 'Choose your mode: Quiz (easy multiple choice) or Riddle (progressive clues). Riddle mode is more challenging but more rewarding!',
    next: 'Next',
    previous: 'Previous',
