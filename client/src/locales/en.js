const en = {
  ...
  review: {
    ...
    none_due: 'No species to review today! 🎉',
    start_count: '📚 {count} species to review',
    start_error: 'Could not start review mode',
  },
  pack_progress: {
    label: '{seen}/{total}',
    seen: 'seen',
    mastered: 'mastered',
    aria: '{percent}% mastered',
  },
  nav: {
  ...
  summary: {
    ...
    lose_title: 'Too bad!',
    explanation_title: 'AI field hint',
    explanation_sources: 'Sources used',
    explanation_detail_title: 'Analyse this photo',
    explanation_detail_button: 'Analyse this photo',
    explanation_detail_loading: 'Photo analysis in progress…',
    brief_key_difference_title: 'What sets them apart',
    brief_why_tempting_title: 'Why the confusion makes sense',
    brief_next_look_for_title: 'Look for this next time',
    photo_analysis_summary_title: 'What we can see here',
    photo_analysis_clues_title: 'Visible clues',
    photo_analysis_mislead_title: 'What may have misled you',
    photo_analysis_next_check_title: 'What to check next',
    photo_analysis_caution_title: 'Read with caution',
    sources_toggle_show: 'Show sources',
    sources_toggle_hide: 'Hide sources',
    sources_empty: 'No detailed sources are available for this hint.',
    source_kind_description: 'Description',
    source_kind_image: 'Photo',
    source_kind_taxonomy: 'Taxonomy',
    source_kind_synonymy: 'Synonymy',
    source_kind_distribution: 'Distribution',
    confidence_grounded: 'Grounded sources',
    confidence_model_guided: 'Coherent sources',
    confidence_limited: 'Limited sources',
    confidence_fallback: 'Generic hint',
    photo_confidence_grounded: 'Reliable photo analysis',
    photo_confidence_limited: 'Careful photo analysis',
    photo_confidence_unavailable: 'Photo analysis unavailable',
    sources_image_count: '{count} round photo',
    sources_descriptive_count: '{count} descriptive source(s)',
    sources_taxonomic_count: '{count} taxonomic source(s)',
    sources_other_count: '{count} other source(s)',
    ...
    pedagogy: {
      visual_clue_title: 'Key visual clue',
      taxonomic_rule_title: 'Taxonomic rule',
      counter_example_title: 'Counter-example',
      confusion_reason_title: 'Why the confusion',
    },
    explanation_feedback_label: 'Did this explanation help?',
    explanation_feedback_yes: 'Helpful',
    explanation_feedback_no: 'Not helpful',
  },
  species: {
    tabs: {
      stats: 'My Stats',
  ...
  share: {
    share_result: 'Share my recap',
    copy_text: 'Copy',
    copied: 'Result copied!',
    sharing: 'Preparing recap…',
    copy_fail: 'Could not copy – copy the text manually.',
    opened_recap: 'Recap opened in a new tab.',
    headline: 'I just finished a game on iNaturaQuizz',
    daily_headline: 'I completed today\'s iNaturaQuizz challenge',
    summary_with_pack: 'I recognized {score} species out of {total} in "{pack}" on iNaturaQuizz.',
    summary_without_pack: 'I recognized {score} species out of {total} on iNaturaQuizz.',
    invite: 'Check out my recap and give it a try too:',
    card_cta: 'View the recap and play',
    share_text_copied: 'Share text copied.',
    recap_link_copied: 'Recap link copied.',
    challenge_opened: 'Challenge opened in a new tab.',
    sheet_eyebrow: 'Shareable recap',
    sheet_title: 'Share my recap',
    preview_label: 'species recognized',
    highlight_label: 'Species highlight:',
    highlight_label_card: 'Species highlight',
    option_share_now: 'Share now',
    option_share_now_hint: 'Share or copy a ready-to-send message.',
    option_copy_message: 'Copy the share message',
    option_copy_message_hint: 'Copy a ready-to-post text for WhatsApp, email or social media.',
    option_copy_link: 'Copy the recap link',
    option_copy_link_hint: 'Handy for WhatsApp, email or social media.',
    option_view_recap: 'View the recap',
    option_view_recap_hint: 'Open the public page exactly as it will be shared.',
    option_create_challenge: 'Create a challenge from this game',
    option_create_challenge_hint: 'Copy a link to invite someone to beat this score.',
  ...
  streak: {
    ...
    shield_used: '🛡️ Shield used! Streak preserved.',
    streak_lost: '💔 Streak lost! Starting over.',
  },
  xp: {
    level_label: 'Level',
    level_short: 'Lv.{level}',
    level_aria: 'Level {level}',
  ...
  about: {
    ...
    what_is_quality: 'Every quiz uses "Research Grade" observations from iNaturalist — real naturalist content structured through community identification.',
    ...
    why_privacy_text: 'No third-party tracking, progress stored locally, and pseudonymous first-party product metrics during beta',
    ...
    how_inat_step4: 'Once "Research Grade" = enough community consensus under iNaturalist criteria',
    how_inat_step5: 'iNaturaQuizz uses it for quizzes',
    why_research_grade: 'Why "Research Grade"?',
    research_grade_text: 'iNaturalist applies strict quality criteria. In practice, "Research Grade" mainly depends on verifiable observations and sufficient community agreement on the identification.',
    research_grade_result: 'Result:',
    research_grade_result_text: 'iNaturaQuizz relies on real observations and a community quality framework that is useful for learning.',
  ...
  legal: {
    ...
    data_1: 'Game progress is stored locally in your browser (IndexedDB). Preferences (language, theme, mode) are stored locally (localStorage).',
    data_2: 'Bug reports (when you use the form): report text, current URL, browser, timestamp, and an abuse-prevention IP hash. Limited retention with automatic purge.',
    data_3: 'First-party beta product metrics (for example app open, round start/complete, API/client errors, report success) under a pseudonymous identifier. No email required.',
    no_tracking_title: 'No tracking',
    no_tracking: 'Inaturamouche uses no third-party cookies, no ad tracking pixels, and no third-party analytics SDKs (no Google Analytics, no Facebook Pixel). Data is never sold or shared for marketing.',
    your_rights_title: 'Your rights',
    your_rights: 'Under GDPR, you can delete local data at any time by clearing site data in your browser and request report deletion through the project contact.',
  ...
  pack_share: {
    invalid: 'Pack not found',
    invalid_text: 'This pack link is invalid.',
    import_title: 'Import a pack',
    import_btn: 'Import this pack',
    imported: 'Pack imported successfully!',
    play_now: 'Play now',
    taxa_include: 'Included taxa:',
    taxa_exclude: 'Excluded taxa:',
    place: 'Place:',
    map_area: 'Map area',
    period: 'Period:',
    no_filters: 'No particular filters',
    save_btn: 'Save',
    share_btn: 'Share',
    name_placeholder: 'Pack name…',
    saved: 'Pack saved!',
    default_name: 'Custom pack',
    link_copied: 'Pack link copied!',
    copy_failed: 'Copy failed',
    my_packs: 'My packs',
    delete: 'Delete',
  },
  results_share: {
    invalid: 'Results not found',
    invalid_text: 'This results link is invalid or has expired.',
    loading: 'Loading results…',
    kicker: 'Shared recap',
    hero_title: '{name} recognized {correct} species out of {total}',
    hero_text: 'This game shows what you can learn to recognize from real observations.',
    hero_text_pack: 'In the "{pack}" pack, this game shows what you can learn to recognize from real observations.',
    correct: 'Species recognized',
    accuracy: 'Accuracy',
    highlights: 'Highlights',
    species_title: 'Species highlights',
    species_intro: 'A few species from this game, to make you want to play or beat the score.',
    species_correct: 'Recognized',
    species_wrong: 'Review next',
    show_more_species: 'See the other {count} species',
    cta_title: 'Your turn',
    cta_text: 'Play a pack, discover real species and compare your own recap at the end.',
    primary_cta: 'Try iNaturaQuizz',
    secondary_cta: 'Beat this pack',
    share_button: 'Share my results',
    copied: 'Link copied to clipboard!',
    copy_failed: 'Copy failed',
    play_cta: 'Try iNaturaQuizz',
