const nl = {
  ...
  review: {
    ...
    none_due: 'Geen soorten om vandaag te herzien! 🎉',
    start_count: '📚 {count} soort(en) om te herzien',
    start_error: 'Herzieningsmodus kon niet worden gestart',
  },
  pack_progress: {
    label: '{seen}/{total}',
    seen: 'gezien',
    mastered: 'beheerst',
    aria: '{percent}% beheerst',
  },
  nav: {
  ...
  summary: {
    ...
    lose_title: 'Jammer!',
    explanation_title: 'AI-veldhint',
    explanation_sources: 'Gebruikte bronnen',
    explanation_detail_title: 'Analyse van deze foto',
    explanation_detail_button: 'Analyseer deze foto',
    explanation_detail_loading: 'Fotoanalyse bezig…',
    brief_key_difference_title: 'Wat het verschil maakt',
    brief_why_tempting_title: 'Waarom de vergissing logisch is',
    brief_next_look_for_title: 'Kijk hier de volgende keer naar',
    photo_analysis_summary_title: 'Wat hier zichtbaar is',
    photo_analysis_clues_title: 'Zichtbare aanwijzingen',
    photo_analysis_mislead_title: 'Wat misleidend kon zijn',
    photo_analysis_next_check_title: 'Wat je daarna moet controleren',
    photo_analysis_caution_title: 'Voorzichtige lezing',
    sources_toggle_show: 'Bronnen tonen',
    sources_toggle_hide: 'Bronnen verbergen',
    sources_empty: 'Er zijn geen gedetailleerde bronnen beschikbaar voor deze hint.',
    source_kind_description: 'Beschrijving',
    source_kind_image: 'Foto',
    source_kind_taxonomy: 'Taxonomie',
    source_kind_synonymy: 'Synoniemen',
    source_kind_distribution: 'Verspreiding',
    confidence_grounded: 'Onderbouwde bronnen',
    confidence_model_guided: 'Samenhangende bronnen',
    confidence_limited: 'Beperkte bronnen',
    confidence_fallback: 'Algemene hint',
    photo_confidence_grounded: 'Betrouwbare fotoanalyse',
    photo_confidence_limited: 'Voorzichtige fotoanalyse',
    photo_confidence_unavailable: 'Fotoanalyse niet beschikbaar',
    sources_image_count: '{count} rondefoto',
    sources_descriptive_count: '{count} beschrijvende bron(nen)',
    sources_taxonomic_count: '{count} taxonomische bron(nen)',
    sources_other_count: '{count} andere bron(nen)',
    ...
    pedagogy: {
      visual_clue_title: 'Belangrijke visuele aanwijzing',
      taxonomic_rule_title: 'Taxonomische regel',
      counter_example_title: 'Tegenvoorbeeld',
      confusion_reason_title: 'Waarom de verwarring ontstaat',
    },
    explanation_feedback_label: 'Heeft deze uitleg geholpen?',
    explanation_feedback_yes: 'Nuttig',
    explanation_feedback_no: 'Niet nuttig',
  },
  species: {
    tabs: {
      stats: 'Statistieken',
  ...
  share: {
    share_result: 'Mijn recap delen',
    copy_text: 'Kopiëren',
    copied: 'Resultaat gekopieerd!',
    sharing: 'Recap voorbereiden…',
    copy_fail: 'Kon niet kopiëren – kopieer de tekst handmatig.',
    opened_recap: 'Recap geopend in een nieuw tabblad.',
    headline: 'Ik heb net een spelletje op iNaturaQuizz afgerond',
    daily_headline: 'Ik heb de iNaturaQuizz-uitdaging van vandaag voltooid',
    summary_with_pack: 'Ik herkende {score} soorten op {total} in "{pack}" op iNaturaQuizz.',
    summary_without_pack: 'Ik herkende {score} soorten op {total} op iNaturaQuizz.',
    invite: 'Bekijk mijn recap en probeer het ook eens:',
    card_cta: 'Bekijk de recap en speel',
    share_text_copied: 'Deeltekst gekopieerd.',
    recap_link_copied: 'Recaplink gekopieerd.',
    challenge_opened: 'Uitdaging geopend in een nieuw tabblad.',
    sheet_eyebrow: 'Deelbare recap',
    sheet_title: 'Mijn recap delen',
    preview_label: 'herkende soorten',
    highlight_label: 'Soort in de kijker:',
    highlight_label_card: 'Soort in de kijker',
    option_share_now: 'Nu delen',
    option_share_now_hint: 'Deel of kopieer een kant-en-klaar bericht.',
    option_copy_message: 'Deelbericht kopiëren',
    option_copy_message_hint: 'Kopieer een tekst voor WhatsApp, e-mail of sociale media.',
    option_copy_link: 'Recaplink kopiëren',
    option_copy_link_hint: 'Handig voor WhatsApp, e-mail of sociale media.',
    option_view_recap: 'Recap bekijken',
    option_view_recap_hint: 'Open de publieke pagina precies zoals die gedeeld wordt.',
    option_create_challenge: 'Een uitdaging maken van dit spel',
    option_create_challenge_hint: 'Kopieer een link om iemand uit te nodigen beter te doen.',
  ...
  streak: {
    ...
    shield_used: '🛡️ Schild gebruikt! Reeks behouden.',
    streak_lost: '💔 Reeks verloren! Opnieuw beginnen.',
  },
  xp: {
    level_label: 'Niveau',
  ...
  about: {
    ...
    what_is_quality: 'Elke quiz gebruikt "Research Grade"-waarnemingen van iNaturalist — echte natuurdata, gestructureerd via identificatie door de gemeenschap.',
    ...
    why_privacy_text: 'Geen tracking van derden, voortgang lokaal opgeslagen en pseudonieme first-party productmetriek tijdens de bèta',
    ...
    how_inat_step4: 'Eenmaal "Research Grade" = voldoende consensus van de gemeenschap volgens iNaturalist-criteria',
    how_inat_step5: 'iNaturaQuizz gebruikt het voor quizzen',
    why_research_grade: 'Waarom "Research Grade"?',
    research_grade_text: 'iNaturalist hanteert strikte kwaliteitscriteria. In de praktijk hangt "Research Grade" vooral af van verifieerbare waarnemingen en voldoende overeenstemming binnen de gemeenschap over de identificatie.',
    research_grade_result: 'Resultaat:',
    research_grade_result_text: 'iNaturaQuizz steunt op echte waarnemingen en een communautair kwaliteitskader dat nuttig is voor leren.',
  ...
  pack_share: {
    invalid: 'Pack niet gevonden',
    invalid_text: 'Deze packlink is ongeldig.',
    import_title: 'Een pack importeren',
    import_btn: 'Dit pack importeren',
    imported: 'Pack succesvol geïmporteerd!',
    play_now: 'Nu spelen',
    taxa_include: 'Opgenomen taxa:',
    taxa_exclude: 'Uitgesloten taxa:',
    place: 'Plaats:',
    map_area: 'Kaartgebied',
    period: 'Periode:',
    no_filters: 'Geen bijzondere filters',
    save_btn: 'Opslaan',
    share_btn: 'Delen',
    name_placeholder: 'Packnaam…',
    saved: 'Pack opgeslagen!',
    default_name: 'Aangepast pack',
    link_copied: 'Packlink gekopieerd!',
    copy_failed: 'Kopiëren mislukt',
    my_packs: 'Mijn packs',
    delete: 'Verwijderen',
  },
  results_share: {
    invalid: 'Resultaten niet gevonden',
    invalid_text: 'Deze resultatenlink is ongeldig of verlopen.',
    loading: 'Resultaten laden…',
    kicker: 'Gedeelde recap',
    hero_title: '{name} herkende {correct} soorten op {total}',
    hero_text: 'Dit spel laat zien wat je kunt leren herkennen met echte waarnemingen.',
    hero_text_pack: 'In het pack "{pack}" laat dit spel zien wat je kunt leren herkennen met echte waarnemingen.',
    correct: 'Herkende soorten',
    accuracy: 'Nauwkeurigheid',
    highlights: 'Uitgelichte soorten',
    species_title: 'Soorten in de kijker',
    species_intro: 'Enkele soorten uit dit spel om zin te krijgen om zelf te spelen of beter te doen.',
    species_correct: 'Herkend',
    species_wrong: 'Nog eens bekijken',
    show_more_species: 'Bekijk de andere {count} soorten',
    cta_title: 'Nu jij',
    cta_text: 'Speel een pack, ontdek echte soorten en vergelijk op het einde je eigen recap.',
    primary_cta: 'Probeer iNaturaQuizz',
    secondary_cta: 'Doe beter op dit pack',
    share_button: 'Mijn resultaten delen',
    copied: 'Link gekopieerd naar klembord!',
    copy_failed: 'Kopiëren mislukt',
    play_cta: 'Probeer iNaturaQuizz',
