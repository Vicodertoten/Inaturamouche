...
define(['./workbox-bfd2dca0'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname === "/api/quiz-question", new workbox.NetworkOnly({
  ...
  workbox.registerRoute(/^https:\/\/static\.inaturalist\.org\/photos\//, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/inaturalist-open-data\.s3\.amazonaws\.com\//, new workbox.CacheFirst({
